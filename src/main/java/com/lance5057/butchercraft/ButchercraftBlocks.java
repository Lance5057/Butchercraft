...
public class ButchercraftBlocks {
	...
	public static final DeferredBlock<Block> BEEF_BLOCK = BLOCKS.register("beef_block",
			() -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE).mapColor(MapColor.COLOR_RED)
					.sound(SoundType.SLIME_BLOCK)));
	public static final DeferredBlock<Block> COOKED_BEEF_BLOCK = BLOCKS.register("cooked_beef_block",
			() -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE).mapColor(MapColor.COLOR_BROWN)
					.sound(SoundType.SLIME_BLOCK)));

	public static final DeferredBlock<Block> PORK_BLOCK = BLOCKS.register("pork_block",
			() -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE).mapColor(MapColor.COLOR_RED)
					.sound(SoundType.SLIME_BLOCK)));
	public static final DeferredBlock<Block> COOKED_PORK_BLOCK = BLOCKS.register("cooked_pork_block",
			() -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE).mapColor(MapColor.COLOR_BROWN)
					.sound(SoundType.SLIME_BLOCK)));

	public static final DeferredBlock<Block> MUTTON_BLOCK = BLOCKS.register("mutton_block",
			() -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE).mapColor(MapColor.COLOR_RED)
					.sound(SoundType.SLIME_BLOCK)));
	public static final DeferredBlock<Block> COOKED_MUTTON_BLOCK = BLOCKS.register("cooked_mutton_block",
			() -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE).mapColor(MapColor.COLOR_BROWN)
					.sound(SoundType.SLIME_BLOCK)));

	public static final DeferredBlock<Block> GOAT_BLOCK = BLOCKS.register("goat_block",
			() -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE).mapColor(MapColor.COLOR_RED)
					.sound(SoundType.SLIME_BLOCK)));
	public static final DeferredBlock<Block> COOKED_GOAT_BLOCK = BLOCKS.register("cooked_goat_block",
			() -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE).mapColor(MapColor.COLOR_BROWN)
					.sound(SoundType.SLIME_BLOCK)));

	public static final DeferredBlock<Block> RABBIT_BLOCK = BLOCKS.register("rabbit_block",
			() -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE).mapColor(MapColor.COLOR_RED)
					.sound(SoundType.SLIME_BLOCK)));
	...
	public static final DeferredBlock<Block> CHICKEN_BLOCK = BLOCKS.register("chicken_block",
			() -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE).mapColor(MapColor.COLOR_RED)
					.sound(SoundType.SLIME_BLOCK)));
	...
	public static final DeferredBlock<RotatedPillarBlock> SAUSAGE_BLOCK = BLOCKS.register("sausage_block",
			() -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE)
					.mapColor(MapColor.COLOR_RED).sound(SoundType.SLIME_BLOCK)));
	public static final DeferredBlock<RotatedPillarBlock> COOKED_SAUSAGE_BLOCK = BLOCKS.register("cooked_sausage_block",
			() -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE)
					.mapColor(MapColor.COLOR_BROWN).sound(SoundType.SLIME_BLOCK)));
	...
	public static final DeferredBlock<HideBlock> COW_HIDE_CARPET = BLOCKS.register("cow_hide_carpet",
			() -> new HideBlock(
					BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_WOOL).mapColor(MapColor.COLOR_BROWN)));
	...
	public static final DeferredBlock<LiquidBlock> BLOOD_FLUID_BLOCK = ButchercraftBlocks.BLOCKS
			.register("blood_fluid_block", () -> new LiquidBlock(ButchercraftFluids.BLOOD.FLUID.get(),
...
//					BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noCollission().strength(100.0F).noLootTable()));
	...
	public static final DeferredBlock<WallSkullBlock> COW_SKULL_HEAD_WALL = BLOCKS.register("cow_skull_head_wall",
			() -> new AnimalWallHeadBlock(AnimalHeadBlock.Types.COW_SKULL, BlockBehaviour.Properties
					.ofFullCopy(Blocks.SKELETON_WALL_SKULL).strength(1.0F).lootFrom(COW_SKULL_HEAD)));
	...
	public static final DeferredBlock<WallSkullBlock> CHICKEN_HEAD_WALL = BLOCKS.register("chicken_head_wall",
			() -> new AnimalWallHeadBlock(AnimalHeadBlock.Types.CHICKEN, BlockBehaviour.Properties
					.ofFullCopy(Blocks.PLAYER_WALL_HEAD).strength(1.0F).lootFrom(CHICKEN_HEAD)));
	...
	public static final DeferredBlock<WallSkullBlock> GOAT_SKULL_HEAD_WALL = BLOCKS.register("goat_skull_head_wall",
			() -> new AnimalWallHeadBlock(AnimalHeadBlock.Types.GOAT_SKULL, BlockBehaviour.Properties
					.ofFullCopy(Blocks.SKELETON_WALL_SKULL).strength(1.0F).lootFrom(GOAT_SKULL_HEAD)));
	...
	public static final DeferredBlock<WallSkullBlock> PIG_SKULL_HEAD_WALL = BLOCKS.register("pig_skull_head_wall",
			() -> new AnimalWallHeadBlock(AnimalHeadBlock.Types.PIG_SKULL, BlockBehaviour.Properties
					.ofFullCopy(Blocks.SKELETON_WALL_SKULL).strength(1.0F).lootFrom(PIG_SKULL_HEAD)));
	...
	public static final DeferredBlock<AnimalHeadBlock> RABBIT_BROWN_HEAD = BLOCKS.register("rabbit_brown_head",
			() -> new AnimalHeadBlock(AnimalHeadBlock.Types.RABBIT_BROWN,
					BlockBehaviour.Properties.ofFullCopy(Blocks.PLAYER_HEAD).strength(1.0F)));
	public static final DeferredBlock<WallSkullBlock> RABBIT_BROWN_HEAD_WALL = BLOCKS.register("rabbit_brown_head_wall",
	...
	public static final DeferredBlock<AnimalHeadBlock> RABBIT_BLACK_HEAD = BLOCKS.register("rabbit_black_head",
			() -> new AnimalHeadBlock(AnimalHeadBlock.Types.RABBIT_BLACK,
					BlockBehaviour.Properties.ofFullCopy(Blocks.PLAYER_HEAD).strength(1.0F)));
	public static final DeferredBlock<WallSkullBlock> RABBIT_BLACK_HEAD_WALL = BLOCKS.register("rabbit_black_head_wall",
	...
	public static final DeferredBlock<AnimalHeadBlock> RABBIT_WHITE_HEAD = BLOCKS.register("rabbit_white_head",
			() -> new AnimalHeadBlock(AnimalHeadBlock.Types.RABBIT_WHITE,
					BlockBehaviour.Properties.ofFullCopy(Blocks.PLAYER_HEAD).strength(1.0F)));
	public static final DeferredBlock<WallSkullBlock> RABBIT_WHITE_HEAD_WALL = BLOCKS.register("rabbit_white_head_wall",
	...
	public static final DeferredBlock<AnimalHeadBlock> RABBIT_SKULL_HEAD = BLOCKS.register("rabbit_skull_head",
			() -> new AnimalHeadBlock(AnimalHeadBlock.Types.RABBIT_SKULL,
					BlockBehaviour.Properties.ofFullCopy(Blocks.SKELETON_SKULL).strength(1.0F)));
	public static final DeferredBlock<WallSkullBlock> RABBIT_SKULL_HEAD_WALL = BLOCKS.register("rabbit_skull_head_wall",
	...
	public static final DeferredBlock<Block> BARN_WOOD_BLOCK = BLOCKS.register("barn_wood_block",
			() -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD).mapColor(MapColor.COLOR_RED)
	...
	public static final DeferredBlock<FenceGateBlock> BARN_WOOD_FENCE_GATE = BLOCKS.register("barn_wood_fence_gate",
			() -> new FenceGateBlock(BARN_WOOD_TYPE, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_FENCE_GATE)
					.mapColor(MapColor.COLOR_RED).sound(SoundType.WOOD).strength(3.0F)));
	public static final DeferredBlock<DoorBlock> BARN_WOOD_DOOR = BLOCKS.register("barn_wood_door",
			() -> new DoorBlock(BARN_WOOD_SET, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_DOOR)
					.mapColor(MapColor.COLOR_RED).sound(SoundType.WOOD).strength(3.0F).noOcclusion()));
	public static final DeferredBlock<TrapDoorBlock> BARN_WOOD_TRAPDOOR = BLOCKS.register("barn_wood_trapdoor",
			() -> new TrapDoorBlock(BARN_WOOD_SET, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_TRAPDOOR)
					.mapColor(MapColor.COLOR_RED).sound(SoundType.WOOD).strength(3.0F).noOcclusion()));

	public static final DeferredBlock<Block> TRIMMED_BARN_WOOD_BLOCK = BLOCKS.register("trimmed_barn_wood_block",
			() -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD).mapColor(MapColor.COLOR_RED)
					.sound(SoundType.WOOD).strength(3.0F)));
