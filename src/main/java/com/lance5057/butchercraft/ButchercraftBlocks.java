...
public class ButchercraftBlocks {
    ...
    public static final RegistryObject<MeatHookBlock> MEAT_HOOK = BLOCKS.register("meat_hook",
            MeatHookBlock::new);
    public static final RegistryObject<Block> COW_SKULL = BLOCKS.register("cow_skull", () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.STONE)));
