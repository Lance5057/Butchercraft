...
public class ButchercraftBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<SkullBlockEntity>> SKULL = BLOCK_ENTITIES
			.register("skull",
					() -> BlockEntityType.Builder.of(SkullBlockEntity::new, ButchercraftBlocks.COW_HEAD.get(),
							ButchercraftBlocks.CHICKEN_HEAD.get(), ButchercraftBlocks.SHEEP_HEAD.get(),
							ButchercraftBlocks.PIG_HEAD.get(), ButchercraftBlocks.GOAT_HEAD.get(),
							ButchercraftBlocks.RABBIT_BLACK_HEAD.get(),
							ButchercraftBlocks.RABBIT_BROWN_HEAD.get(),
							ButchercraftBlocks.RABBIT_GOLD_HEAD.get(),
							ButchercraftBlocks.RABBIT_SALT_HEAD.get(),
							ButchercraftBlocks.RABBIT_SPLOTCHED_HEAD.get(),
							ButchercraftBlocks.RABBIT_WHITE_HEAD.get()).build(null));
	...
	public static final RegistryObject<BlockEntityType<SkullBlockEntity>> WALL_SKULL = BLOCK_ENTITIES.register(
			...
			() -> BlockEntityType.Builder.of(SkullBlockEntity::new, ButchercraftBlocks.COW_HEAD_WALL.get(),
					ButchercraftBlocks.CHICKEN_HEAD_WALL.get(), ButchercraftBlocks.SHEEP_HEAD_WALL.get(),
					ButchercraftBlocks.PIG_HEAD_WALL.get(), ButchercraftBlocks.GOAT_HEAD_WALL.get(),
					...
					ButchercraftBlocks.RABBIT_WHITE_HEAD_WALL.get()).build(null));
