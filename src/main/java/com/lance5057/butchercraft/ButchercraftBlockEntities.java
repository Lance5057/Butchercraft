...
public class ButchercraftBlockEntities {
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<MeatHookBlockEntity>> MEAT_HOOK = BLOCK_ENTITIES
			.register("meat_hook", () -> BlockEntityType.Builder
					.of(MeatHookBlockEntity::new, ButchercraftBlocks.MEAT_HOOK.get()).build(null));
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<GrinderBlockEntity>> GRINDER = BLOCK_ENTITIES
			.register("grinder", () -> BlockEntityType.Builder
					.of(GrinderBlockEntity::new, ButchercraftBlocks.GRINDER.get()).build(null));

//	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<SkullBlockEntity>> WALL_SKULL = BLOCK_ENTITIES.register(
//			"wall_skull",
//			() -> BlockEntityType.Builder.of(SkullBlockEntity::new
//					.build(null));

	public static void addSkulls(BlockEntityTypeAddBlocksEvent event) {
		event.modify(BlockEntityType.SKULL, ButchercraftBlocks.COW_HEAD.get(), ButchercraftBlocks.COW_SKULL_HEAD.get(),
				ButchercraftBlocks.CHICKEN_HEAD.get(), ButchercraftBlocks.CHICKEN_SKULL_HEAD.get(),
				ButchercraftBlocks.SHEEP_HEAD.get(), ButchercraftBlocks.SHEEP_SKULL_HEAD.get(),
				ButchercraftBlocks.PIG_HEAD.get(), ButchercraftBlocks.PIG_SKULL_HEAD.get(),
				ButchercraftBlocks.GOAT_HEAD.get(), ButchercraftBlocks.GOAT_SKULL_HEAD.get(),
				ButchercraftBlocks.RABBIT_BLACK_HEAD.get(), ButchercraftBlocks.RABBIT_BROWN_HEAD.get(),
				ButchercraftBlocks.RABBIT_GOLD_HEAD.get(), ButchercraftBlocks.RABBIT_SALT_HEAD.get(),
				ButchercraftBlocks.RABBIT_SPLOTCHED_HEAD.get(), ButchercraftBlocks.RABBIT_WHITE_HEAD.get(),
				ButchercraftBlocks.RABBIT_SKULL_HEAD.get(), ButchercraftBlocks.COW_HEAD_WALL.get(),
