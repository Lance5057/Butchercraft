...
public class MeatHookEmiRecipe implements EmiRecipe {
	...
	public EmiRecipeCategory getCategory() {
		return EMIPlugin.MEAT_HOOK_CATEGORY;
	}
	...
	public void addWidgets(WidgetHolder widgets) {
		widgets.addTexture(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "textures/gui/jei.png"), 0, 0, 144, 144, 0, 78);
		...
		widgets.addSlot(this.inputs.getFirst(), (this.getDisplayWidth() / 2 - 9), 64).drawBack(false);
