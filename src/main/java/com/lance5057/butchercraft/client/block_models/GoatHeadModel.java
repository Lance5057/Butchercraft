...
public class GoatHeadModel extends SkullModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "goathead"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(12, 55)
						...
						.mirror().addBox(3.0F, -8.0F, 0.0F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(2, 61).addBox(-5.0F, -8.0F, 0.0F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(23, 52).addBox(0.5F, 0.0F, -4.0F, 0.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)),
