...
public class MeatHookLoottables implements LootTableSubProvider {
	...
	public static final ResourceKey<LootTable> SKIN_COW = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/skin_cow"));
	public static final ResourceKey<LootTable> DISEMBOWEL_COW = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/deoffal_cow"));
	public static final ResourceKey<LootTable> BISECT_COW = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/delimb_cow"));
	public static final ResourceKey<LootTable> BUTCHER_COW = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/butcher_cow"));

	public static final ResourceKey<LootTable> SKIN_PIG = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/skin_pig"));
	public static final ResourceKey<LootTable> DISEMBOWEL_PIG = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/disembowel_pig"));
	public static final ResourceKey<LootTable> BISECT_PIG = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/bisect_pig"));
	public static final ResourceKey<LootTable> BUTCHER_PIG = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/butcher_pig"));

	public static final ResourceKey<LootTable> SKIN_SHEEP = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/skin_sheep"));
	public static final ResourceKey<LootTable> DISEMBOWEL_SHEEP = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/disembowel_sheep"));
	public static final ResourceKey<LootTable> BISECT_SHEEP = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/bisect_sheep"));
	public static final ResourceKey<LootTable> BUTCHER_SHEEP = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/butcher_sheep"));

	public static final ResourceKey<LootTable> SKIN_GOAT = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/skin_goat"));
	public static final ResourceKey<LootTable> DISEMBOWEL_GOAT = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/disembowel_goat"));
	public static final ResourceKey<LootTable> BISECT_GOAT = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/bisect_goat"));
	public static final ResourceKey<LootTable> BUTCHER_GOAT = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/butcher_goat"));

	public static final ResourceKey<LootTable> BLOOD_BUCKET = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/blood_bucket"));

	public static final ResourceKey<LootTable> SCRAPE_HIDE = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/scrape_hide"));
	public static final ResourceKey<LootTable> COW_LEATHER = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/cow_leather"));
	public static final ResourceKey<LootTable> GOAT_LEATHER = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/goat_leather"));
	public static final ResourceKey<LootTable> PIG_LEATHER = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/pig_leather"));
	public static final ResourceKey<LootTable> SHEEP_LEATHER = ResourceKey.create(Registries.LOOT_TABLE,
			ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook/sheep_leather"));
	...
	public void generate(BiConsumer<ResourceKey<LootTable>, Builder> t) {
		...
		t.accept(BISECT_COW,
				LootTable.lootTable().withPool(createPoolWithItem(ButchercraftItems.COW_HEAD_ITEM.get()))
						...
						.withPool(createPoolWithItem(ButchercraftItems.HOOF.get(), 4, 0, 1, provider)));
		...
		t.accept(BISECT_PIG,
				LootTable.lootTable().withPool(createPoolWithItem(ButchercraftItems.PIG_HEAD_ITEM.get()))
						.withPool(createPoolWithItem(ButchercraftItems.HOOF.get(), 4, 0, 1, provider))
		...
		t.accept(BUTCHER_SHEEP,
				LootTable.lootTable()
						.withPool(createPoolWithItem(ButchercraftItems.MUTTON_SCRAPS.get(), 5, 0, 1, provider))
		...
		t.accept(BUTCHER_GOAT,
				LootTable.lootTable()
						.withPool(createPoolWithItem(ButchercraftItems.GOAT_SCRAPS.get(), 5, 0, 1, provider))
