...
public class ButchercraftRecipeProvider extends RecipeProvider {
	...
	public ButchercraftRecipeProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
	...
	List<RecipeMobEffect> CARCASS_DEFAULT = List.of(
			new RecipeMobEffect(ButchercraftMobEffects.DIRTY.getId(), 3600, 1, 0.8f),
			new RecipeMobEffect(ButchercraftMobEffects.BLOODTRAIL.getId(), 3600, 1, 0.8f),
			new RecipeMobEffect(ButchercraftMobEffects.STINKY.getId(), 3600, 1, 0.8f),
			new RecipeMobEffect(ButchercraftMobEffects.BLOODY.getId(), 3600, 1, 0.8f));

	List<RecipeMobEffect> RAW_MEAT_DEFAULT = List.of(
			new RecipeMobEffect(ButchercraftMobEffects.DIRTY.getId(), 3600, 1, 0.5f),
			new RecipeMobEffect(ButchercraftMobEffects.STINKY.getId(), 3600, 1, 0.25f));

	List<RecipeMobEffect> EMPTY = List.of();

	@Override
	protected void buildRecipes(RecipeOutput consumer) {
		MeatHookRecipeBuilder.recipe(ButchercraftItems.CARCASS.get(), ResourceLocation.withDefaultNamespace("cow"))
				.tool(Ingredient.of(Items.BUCKET), 1, true, MeatHookLoottables.BLOOD_BUCKET, CARCASS_DEFAULT,
						standardModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/cow")),
				...
				.tool(Ingredient.of(ButchercraftItems.BONE_SAW.get()), 12, true, MeatHookLoottables.BISECT_COW,
						CARCASS_DEFAULT,
						standardModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/cow_skinned")),
				...
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 12, true, MeatHookLoottables.DISEMBOWEL_COW,
						CARCASS_DEFAULT,
						standardModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/cow_gutted")),
				...
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 12, true, MeatHookLoottables.BUTCHER_COW,
						CARCASS_DEFAULT,
						standardModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/cow_bisected")),
		...
		MeatHookRecipeBuilder.recipe(ButchercraftItems.CARCASS.get(), ResourceLocation.withDefaultNamespace("sheep"))
				.tool(Ingredient.of(Items.BUCKET), 1, true, MeatHookLoottables.BLOOD_BUCKET, CARCASS_DEFAULT,
						standardModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/sheep")),
						standardHookToolModel(Items.BUCKET))
				...
				.tool(Ingredient.of(ButchercraftItems.BONE_SAW.get()), 12, true, MeatHookLoottables.BISECT_SHEEP,
						CARCASS_DEFAULT,
						standardModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/sheep_skinned")),
						standardHookToolModel(ButchercraftItems.BONE_SAW.get()))
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 12, true, MeatHookLoottables.DISEMBOWEL_SHEEP,
						CARCASS_DEFAULT,
						standardModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/sheep_gutted")),
						standardHookToolModel(ButchercraftItems.GUT_KNIFE.get()))
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 12, true, MeatHookLoottables.BUTCHER_SHEEP,
						CARCASS_DEFAULT,
						standardModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/sheep_bisected")),
						standardHookToolModel(ButchercraftItems.BUTCHER_KNIFE.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.BLOOD_FLUID_BUCKET.get()))
		...
		MeatHookRecipeBuilder.recipe(ButchercraftItems.CARCASS.get(), ResourceLocation.withDefaultNamespace("pig"))
				.tool(Ingredient.of(Items.BUCKET), 1, true, MeatHookLoottables.BLOOD_BUCKET, CARCASS_DEFAULT,
						standardModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/pig")),
						standardHookToolModel(Items.BUCKET))
				.tool(Ingredient.of(Items.BUCKET), 1, true, MeatHookLoottables.BLOOD_BUCKET, CARCASS_DEFAULT,
						standardModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/pig")),
						standardHookToolModel(Items.BUCKET))
				...
				.tool(Ingredient.of(ButchercraftItems.BONE_SAW.get()), 12, true, MeatHookLoottables.BISECT_PIG,
						CARCASS_DEFAULT,
						standardModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/pig_skinned")),
						standardHookToolModel(ButchercraftItems.BONE_SAW.get()))
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 12, true, MeatHookLoottables.DISEMBOWEL_PIG,
						CARCASS_DEFAULT,
						standardModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/pig_gutted")),
						standardHookToolModel(ButchercraftItems.GUT_KNIFE.get()))
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 12, true, MeatHookLoottables.BUTCHER_PIG,
						CARCASS_DEFAULT,
						standardModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/pig_bisected")),
						standardHookToolModel(ButchercraftItems.BUTCHER_KNIFE.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.BLOOD_FLUID_BUCKET.get()))
		...
		MeatHookRecipeBuilder.recipe(ButchercraftItems.CARCASS.get(), ResourceLocation.withDefaultNamespace("goat"))
				.tool(Ingredient.of(Items.BUCKET), 1, true, MeatHookLoottables.BLOOD_BUCKET, CARCASS_DEFAULT,
						standardModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/goat")),
						standardHookToolModel(Items.BUCKET))
				...
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 12, true, MeatHookLoottables.DISEMBOWEL_GOAT,
						CARCASS_DEFAULT,
						standardModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/goat_gutted")),
						standardHookToolModel(ButchercraftItems.GUT_KNIFE.get()))
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 12, true, MeatHookLoottables.BUTCHER_GOAT,
						CARCASS_DEFAULT,
						standardModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/goat_bisected")),
						standardHookToolModel(ButchercraftItems.BUTCHER_KNIFE.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.BLOOD_FLUID_BUCKET.get()))
		...
		ButcherBlockRecipeBuilder.recipe(ButchercraftItems.CARCASS.get(), ResourceLocation.withDefaultNamespace("chicken"))
				.tool(Ingredient.of(Items.GLASS_BOTTLE), 1, true, ButcherBlockLootTables.BLOOD_BOTTLE, CARCASS_DEFAULT,
				...
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 12, true,
						ButcherBlockLootTables.DEOFFAL_CHICKEN, CARCASS_DEFAULT,
						standardButcherBlockModel(
		...
		ButcherBlockRecipeBuilder.shapedRecipe(Items.CHICKEN)
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 12, true,
						ButcherBlockLootTables.BUTCHER_CHICKEN, CARCASS_DEFAULT,
						standardButcherBlockModel(
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "butcher_whole_chicken"));

		ButcherBlockRecipeBuilder.recipe(ButchercraftItems.CARCASS.get(), ResourceLocation.withDefaultNamespace("rabbit"))
				.tool(Ingredient.of(Items.GLASS_BOTTLE), 1, true, ButcherBlockLootTables.BLOOD_BOTTLE, CARCASS_DEFAULT,
						standardButcherBlockModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/rabbit_black")),
				...
				.tool(Ingredient.of(ButchercraftItems.SKINNING_KNIFE.get()), 6, true,
						ButcherBlockLootTables.SKIN_BLACK_RABBIT, CARCASS_DEFAULT,
						standardButcherBlockModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/rabbit_black")),
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "butcher_black_rabbit"));

		ButcherBlockRecipeBuilder.recipe(ButchercraftItems.BROWN_RABBIT_CARCASS.get())
				.tool(Ingredient.of(Items.GLASS_BOTTLE), 1, true, ButcherBlockLootTables.BLOOD_BOTTLE, CARCASS_DEFAULT,
						standardButcherBlockModel(
				...
				.JEIIngredient(Ingredient.of(Items.RABBIT))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "butcher_brown_rabbit"));

		ButcherBlockRecipeBuilder.recipe(ButchercraftItems.SPLOTCHED_RABBIT_CARCASS.get())
				.tool(Ingredient.of(Items.GLASS_BOTTLE), 1, true, ButcherBlockLootTables.BLOOD_BOTTLE, CARCASS_DEFAULT,
						standardButcherBlockModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID,
								"meathook/rabbit_splotched")),
						standardButcherBlockToolModel(Items.GLASS_BOTTLE, 0))
				.tool(Ingredient.of(Items.GLASS_BOTTLE), 1, true, ButcherBlockLootTables.BLOOD_BOTTLE, CARCASS_DEFAULT,
						standardButcherBlockModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID,
								"meathook/rabbit_splotched")),
						standardButcherBlockToolModel(Items.GLASS_BOTTLE, 0))
				.tool(Ingredient.of(ButchercraftItems.SKINNING_KNIFE.get()), 6, true,
						ButcherBlockLootTables.SKIN_SPLOTCHED_RABBIT, CARCASS_DEFAULT,
						standardButcherBlockModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID,
								"meathook/rabbit_splotched")),
						standardButcherBlockToolModel(ButchercraftItems.SKINNING_KNIFE.get(), 0))
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 6, true, ButcherBlockLootTables.DEOFFAL_RABBIT,
				...
				.JEIIngredient(Ingredient.of(Items.RABBIT))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "butcher_splotched_rabbit"));

		ButcherBlockRecipeBuilder.recipe(ButchercraftItems.GOLD_RABBIT_CARCASS.get())
				.tool(Ingredient.of(Items.GLASS_BOTTLE), 1, true, ButcherBlockLootTables.BLOOD_BOTTLE, CARCASS_DEFAULT,
						standardButcherBlockModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/rabbit_gold")),
						standardButcherBlockToolModel(Items.GLASS_BOTTLE, 0))
				.tool(Ingredient.of(Items.GLASS_BOTTLE), 1, true, ButcherBlockLootTables.BLOOD_BOTTLE, CARCASS_DEFAULT,
						standardButcherBlockModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/rabbit_gold")),
						standardButcherBlockToolModel(Items.GLASS_BOTTLE, 0))
				.tool(Ingredient.of(ButchercraftItems.SKINNING_KNIFE.get()), 6, true,
						ButcherBlockLootTables.SKIN_GOLD_RABBIT, CARCASS_DEFAULT,
						standardButcherBlockModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/rabbit_gold")),
						standardButcherBlockToolModel(ButchercraftItems.SKINNING_KNIFE.get(), 0))
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 6, true, ButcherBlockLootTables.DEOFFAL_RABBIT,
				...
				.JEIIngredient(Ingredient.of(Items.RABBIT))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "butcher_gold_rabbit"));

		ButcherBlockRecipeBuilder.recipe(ButchercraftItems.SALT_RABBIT_CARCASS.get())
				.tool(Ingredient.of(Items.GLASS_BOTTLE), 1, true, ButcherBlockLootTables.BLOOD_BOTTLE, CARCASS_DEFAULT,
						standardButcherBlockModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/rabbit_salt")),
						standardButcherBlockToolModel(Items.GLASS_BOTTLE, 0))
				.tool(Ingredient.of(Items.GLASS_BOTTLE), 1, true, ButcherBlockLootTables.BLOOD_BOTTLE, CARCASS_DEFAULT,
						standardButcherBlockModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/rabbit_salt")),
						standardButcherBlockToolModel(Items.GLASS_BOTTLE, 0))
				.tool(Ingredient.of(ButchercraftItems.SKINNING_KNIFE.get()), 6, true,
						ButcherBlockLootTables.SKIN_SALT_RABBIT, CARCASS_DEFAULT,
						standardButcherBlockModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/rabbit_salt")),
						standardButcherBlockToolModel(ButchercraftItems.SKINNING_KNIFE.get(), 0))
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 6, true, ButcherBlockLootTables.DEOFFAL_RABBIT,
				...
				.JEIIngredient(Ingredient.of(Items.RABBIT))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "butcher_salt_rabbit"));

		ButcherBlockRecipeBuilder.recipe(ButchercraftItems.WHITE_RABBIT_CARCASS.get())
				.tool(Ingredient.of(Items.GLASS_BOTTLE), 1, true, ButcherBlockLootTables.BLOOD_BOTTLE, CARCASS_DEFAULT,
						standardButcherBlockModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/rabbit_white")),
						standardButcherBlockToolModel(Items.GLASS_BOTTLE, 0))
				.tool(Ingredient.of(Items.GLASS_BOTTLE), 1, true, ButcherBlockLootTables.BLOOD_BOTTLE, CARCASS_DEFAULT,
						standardButcherBlockModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/rabbit_white")),
						standardButcherBlockToolModel(Items.GLASS_BOTTLE, 0))
				.tool(Ingredient.of(ButchercraftItems.SKINNING_KNIFE.get()), 6, true,
						ButcherBlockLootTables.SKIN_WHITE_RABBIT, CARCASS_DEFAULT,
						standardButcherBlockModel(
								ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/rabbit_white")),
						standardButcherBlockToolModel(ButchercraftItems.SKINNING_KNIFE.get(), 0))
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 6, true, ButcherBlockLootTables.DEOFFAL_RABBIT,
				...
				.JEIIngredient(Ingredient.of(Items.RABBIT))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "butcher_white_rabbit"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(Items.RABBIT)
				...
				.JEIIngredient(Ingredient.of(Items.BONE_MEAL))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "butcher_whole_rabbit"));

		MeatHookRecipeBuilder.recipe(ButchercraftItems.COW_HIDE.get())
				.tool(Ingredient.of(ButchercraftItems.SKINNING_KNIFE.get()), 6, true, MeatHookLoottables.SCRAPE_HIDE,
						RAW_MEAT_DEFAULT,
						hideModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/cow_hide")),
						standardHookToolModel(ButchercraftItems.SKINNING_KNIFE.get()))
				.tool(Ingredient.of(Items.SHEARS), 6, true, MeatHookLoottables.COW_LEATHER, CARCASS_DEFAULT,
						hideModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/cow_hide")),
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cow_hide"));

		MeatHookRecipeBuilder.recipe(ButchercraftItems.GOAT_HIDE.get())
				.tool(Ingredient.of(ButchercraftItems.SKINNING_KNIFE.get()), 6, true, MeatHookLoottables.SCRAPE_HIDE,
						RAW_MEAT_DEFAULT,
						hideModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/goat_hide")),
						standardHookToolModel(ButchercraftItems.SKINNING_KNIFE.get()))
				.tool(Ingredient.of(Items.SHEARS), 6, true, MeatHookLoottables.GOAT_LEATHER, CARCASS_DEFAULT,
						hideModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/goat_hide")),
						standardHookToolModel(Items.SHEARS))
				.JEIIngredient(Ingredient.of(ButchercraftItems.SINEW.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.FAT.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.LEATHER_SCRAP.get()))
				.JEIIngredient(Ingredient.of(Items.LEATHER))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "goat_hide"));

		MeatHookRecipeBuilder.recipe(ButchercraftItems.PIG_HIDE.get())
				.tool(Ingredient.of(ButchercraftItems.SKINNING_KNIFE.get()), 6, true, MeatHookLoottables.SCRAPE_HIDE,
						RAW_MEAT_DEFAULT,
						hideModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/pig_hide")),
						standardHookToolModel(ButchercraftItems.SKINNING_KNIFE.get()))
				.tool(Ingredient.of(Items.SHEARS), 6, true, MeatHookLoottables.PIG_LEATHER, CARCASS_DEFAULT,
						hideModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/pig_hide")),
						standardHookToolModel(Items.SHEARS))
				.JEIIngredient(Ingredient.of(ButchercraftItems.SINEW.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.FAT.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.LEATHER_SCRAP.get()))
				.JEIIngredient(Ingredient.of(Items.LEATHER))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "pig_hide"));

		MeatHookRecipeBuilder.recipe(ButchercraftItems.SHEEP_HIDE.get())
				.tool(Ingredient.of(ButchercraftItems.SKINNING_KNIFE.get()), 6, true, MeatHookLoottables.SCRAPE_HIDE,
						RAW_MEAT_DEFAULT,
						hideModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/sheep_hide")),
						standardHookToolModel(ButchercraftItems.SKINNING_KNIFE.get()))
				.tool(Ingredient.of(Items.SHEARS), 6, true, MeatHookLoottables.SHEEP_LEATHER, CARCASS_DEFAULT,
						hideModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meathook/sheep_hide")),
						standardHookToolModel(Items.SHEARS))
				.JEIIngredient(Ingredient.of(ButchercraftItems.SINEW.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.FAT.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.LEATHER_SCRAP.get()))
				.JEIIngredient(Ingredient.of(Items.LEATHER))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "sheep_hide"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.BLOOD_SAUSAGE_LINKED.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 8, true,
						ButcherBlockLootTables.BLOOD_SAUSAGE_LINKED, RAW_MEAT_DEFAULT,
						layFlatModel(ButchercraftItems.BLOOD_SAUSAGE_LINKED.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.BLOOD_SAUSAGE.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "blood_sausage_linked"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.SAUSAGE_LINKED.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 8, true,
						ButcherBlockLootTables.SAUSAGE_LINKED, RAW_MEAT_DEFAULT,
						layFlatModel(ButchercraftItems.SAUSAGE_LINKED.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.SAUSAGE.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "sausage_linked"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.BEEF_ROAST.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true, ButcherBlockLootTables.BEEF_ROAST,
						RAW_MEAT_DEFAULT, layFlatModel(ButchercraftItems.BEEF_ROAST.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(Items.BEEF))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "beef_roast"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.COOKED_BEEF_ROAST.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_BEEF_ROAST, EMPTY,
						layFlatModel(ButchercraftItems.COOKED_BEEF_ROAST.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(Items.COOKED_BEEF))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_beef_roast"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.PORK_ROAST.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true, ButcherBlockLootTables.PORK_ROAST,
						RAW_MEAT_DEFAULT, layFlatModel(ButchercraftItems.PORK_ROAST.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(Items.PORKCHOP))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "pork_roast"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.COOKED_PORK_ROAST.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_PORK_ROAST, EMPTY,
						layFlatModel(ButchercraftItems.COOKED_PORK_ROAST.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(Items.COOKED_PORKCHOP))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_pork_roast"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.MUTTON_ROAST.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.MUTTON_ROAST, RAW_MEAT_DEFAULT,
						layFlatModel(ButchercraftItems.MUTTON_ROAST.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(Items.MUTTON))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "mutton_roast"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.COOKED_MUTTON_ROAST.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_MUTTON_ROAST, EMPTY,
						layFlatModel(ButchercraftItems.COOKED_MUTTON_ROAST.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(Items.COOKED_MUTTON))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_mutton_roast"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.GOAT_ROAST.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true, ButcherBlockLootTables.GOAT_ROAST,
						RAW_MEAT_DEFAULT, layFlatModel(ButchercraftItems.GOAT_ROAST.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.GOAT_CHOP.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "goat_roast"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.COOKED_GOAT_ROAST.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_GOAT_ROAST, EMPTY,
						layFlatModel(ButchercraftItems.COOKED_GOAT_ROAST.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.COOKED_GOAT_CHOP.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_goat_roast"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(Items.BEEF)
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true, ButcherBlockLootTables.BEEF_CUBES,
						RAW_MEAT_DEFAULT, layFlatModel(Items.BEEF),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.CUBED_BEEF.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "beef_cubes"));

		ButcherBlockRecipeBuilder.shapedRecipe(Items.COOKED_BEEF)
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_BEEF_CUBES, EMPTY, layFlatModel(Items.COOKED_BEEF),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.COOKED_CUBED_BEEF.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_beef_cubes"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(Items.PORKCHOP)
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true, ButcherBlockLootTables.PORK_CUBES,
						RAW_MEAT_DEFAULT, layFlatModel(Items.PORKCHOP),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.CUBED_PORK.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "pork_cubes"));

		ButcherBlockRecipeBuilder.shapedRecipe(Items.COOKED_PORKCHOP)
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_PORK_CUBES, EMPTY, layFlatModel(Items.COOKED_PORKCHOP),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.COOKED_CUBED_PORK.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_pork_cubes"));

		ButcherBlockRecipeBuilder.shapedRecipe(Items.MUTTON)
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.MUTTON_CUBES, RAW_MEAT_DEFAULT, layFlatModel(Items.MUTTON),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.CUBED_MUTTON.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "mutton_cubes"));

		ButcherBlockRecipeBuilder.shapedRecipe(Items.COOKED_MUTTON)
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_MUTTON_CUBES, EMPTY, layFlatModel(Items.COOKED_MUTTON),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.COOKED_CUBED_MUTTON.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_mutton_cubes"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.GOAT_CHOP.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true, ButcherBlockLootTables.GOAT_CUBES,
						RAW_MEAT_DEFAULT, layFlatModel(ButchercraftItems.GOAT_CHOP.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.CUBED_GOAT.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "goat_cubes"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.COOKED_GOAT_CHOP.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_GOAT_CUBES, EMPTY,
						layFlatModel(ButchercraftItems.COOKED_GOAT_CHOP.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.COOKED_CUBED_GOAT.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_goat_cubes"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.CHICKEN_BREAST.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.CHICKEN_CUBES, RAW_MEAT_DEFAULT,
						layFlatModel(ButchercraftItems.CHICKEN_BREAST.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.CUBED_CHICKEN.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "chicken_cubes"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.COOKED_CHICKEN_BREAST.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_CHICKEN_CUBES, EMPTY,
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_chicken_cubes"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.RABBIT_SADDLE.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.RABBIT_CUBES, RAW_MEAT_DEFAULT,
						layFlatModel(ButchercraftItems.RABBIT_SADDLE.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.CUBED_RABBIT.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "rabbit_cubes"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.COOKED_RABBIT_SADDLE.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_RABBIT_CUBES, EMPTY,
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_rabbit_cubes"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.CUBED_BEEF.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true, ButcherBlockLootTables.BEEF_STEW,
						RAW_MEAT_DEFAULT, layFlatModel(ButchercraftItems.CUBED_BEEF.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.BEEF_STEW_MEAT.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "beef_stew"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.COOKED_CUBED_BEEF.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_BEEF_STEW, EMPTY,
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_beef_stew"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.CUBED_PORK.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true, ButcherBlockLootTables.PORK_STEW,
						RAW_MEAT_DEFAULT, layFlatModel(ButchercraftItems.CUBED_PORK.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.PORK_STEW_MEAT.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "pork_stew"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.COOKED_CUBED_PORK.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_PORK_STEW, EMPTY,
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_pork_stew"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.CUBED_MUTTON.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true, ButcherBlockLootTables.MUTTON_STEW,
						RAW_MEAT_DEFAULT, layFlatModel(ButchercraftItems.CUBED_MUTTON.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.MUTTON_STEW_MEAT.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "mutton_stew"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.COOKED_CUBED_MUTTON.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_MUTTON_STEW, EMPTY,
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_mutton_stew"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.CUBED_GOAT.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true, ButcherBlockLootTables.GOAT_STEW,
						RAW_MEAT_DEFAULT, layFlatModel(ButchercraftItems.CUBED_GOAT.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.GOAT_STEW_MEAT.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "goat_stew"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.COOKED_CUBED_GOAT.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_GOAT_STEW, EMPTY,
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_goat_stew"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.CUBED_CHICKEN.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.CHICKEN_STEW, RAW_MEAT_DEFAULT,
						layFlatModel(ButchercraftItems.CUBED_CHICKEN.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.STEW_CHICKEN.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "chicken_stew"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.COOKED_CUBED_CHICKEN.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_CHICKEN_STEW, EMPTY,
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_chicken_stew"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.CUBED_RABBIT.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true, ButcherBlockLootTables.RABBIT_STEW,
						RAW_MEAT_DEFAULT, layFlatModel(ButchercraftItems.CUBED_RABBIT.get()),
						standardButcherBlockToolModel(ButchercraftItems.BUTCHER_KNIFE.get(), 0))
				.JEIIngredient(Ingredient.of(ButchercraftItems.STEW_RABBIT.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "rabbit_stew"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.COOKED_CUBED_RABBIT.get())
				.tool(Ingredient.of(ButchercraftItems.BUTCHER_KNIFE.get()), 4, true,
						ButcherBlockLootTables.COOKED_RABBIT_STEW, EMPTY,
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_rabbit_stew"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.TRIPE.get())
				.tool(Ingredient.of(ButchercraftItems.SKINNING_KNIFE.get()), 4, true, ButcherBlockLootTables.EMPTY,
						RAW_MEAT_DEFAULT, layFlatModel(ButchercraftItems.TRIPE.get()),
						standardButcherBlockToolModel(ButchercraftItems.SKINNING_KNIFE.get(), 0))
				.tool(Ingredient.of(Items.WATER_BUCKET), 1, true, ButcherBlockLootTables.CASING, CARCASS_DEFAULT,
				...
				.JEIIngredient(Ingredient.of(ButchercraftItems.FAT.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.SINEW.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "casing"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.RABBIT_BLACK_HEAD_ITEM.get())
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 4, true,
						ButcherBlockLootTables.BLACK_RABBIT_HEAD, CARCASS_DEFAULT,
						standardModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID,
								"meathook/black_rabbit_head")),
						standardButcherBlockToolModel(ButchercraftItems.GUT_KNIFE.get(), 0))
				...
				.JEIIngredient(Ingredient.of(ButchercraftItems.RABBIT_SCRAPS.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.LEATHER_SCRAP.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "black_rabbit_head"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.RABBIT_BROWN_HEAD_ITEM.get())
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 4, true,
						ButcherBlockLootTables.BROWN_RABBIT_HEAD, CARCASS_DEFAULT,
						standardModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID,
								"meathook/brown_rabbit_head")),
						standardButcherBlockToolModel(ButchercraftItems.GUT_KNIFE.get(), 0))
				...
				.JEIIngredient(Ingredient.of(ButchercraftItems.RABBIT_SCRAPS.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.LEATHER_SCRAP.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "brown_rabbit_head"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.RABBIT_GOLD_HEAD_ITEM.get())
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 4, true,
						ButcherBlockLootTables.GOLD_RABBIT_HEAD, CARCASS_DEFAULT,
						standardModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID,
								"meathook/gold_rabbit_head")),
						standardButcherBlockToolModel(ButchercraftItems.GUT_KNIFE.get(), 0))
				...
				.JEIIngredient(Ingredient.of(ButchercraftItems.RABBIT_SCRAPS.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.LEATHER_SCRAP.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "gold_rabbit_head"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.RABBIT_SALT_HEAD_ITEM.get())
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 4, true,
						ButcherBlockLootTables.SALT_RABBIT_HEAD, CARCASS_DEFAULT,
						standardModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID,
								"meathook/salt_rabbit_head")),
						standardButcherBlockToolModel(ButchercraftItems.GUT_KNIFE.get(), 0))
				...
				.JEIIngredient(Ingredient.of(ButchercraftItems.RABBIT_SCRAPS.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.LEATHER_SCRAP.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "salt_rabbit_head"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.RABBIT_SPLOTCHED_HEAD_ITEM.get())
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 4, true,
						ButcherBlockLootTables.SPLOTCHED_RABBIT_HEAD, CARCASS_DEFAULT,
						standardModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID,
								"meathook/splotched_rabbit_head")),
						standardButcherBlockToolModel(ButchercraftItems.GUT_KNIFE.get(), 0))
				...
				.JEIIngredient(Ingredient.of(ButchercraftItems.RABBIT_SCRAPS.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.LEATHER_SCRAP.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "splotched_rabbit_head"));

		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.RABBIT_WHITE_HEAD_ITEM.get())
				.tool(Ingredient.of(ButchercraftItems.GUT_KNIFE.get()), 4, true,
						ButcherBlockLootTables.WHITE_RABBIT_HEAD, CARCASS_DEFAULT,
						standardModel(ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID,
								"meathook/white_rabbit_head")),
						standardButcherBlockToolModel(ButchercraftItems.GUT_KNIFE.get(), 0))
				...
				.JEIIngredient(Ingredient.of(ButchercraftItems.RABBIT_SCRAPS.get()))
				.JEIIngredient(Ingredient.of(ButchercraftItems.LEATHER_SCRAP.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "white_rabbit_head"));
		...
		ButcherBlockRecipeBuilder.shapedRecipe(ButchercraftItems.CHICKEN_HEAD_ITEM.get())
				...
				.JEIIngredient(Ingredient.of(Items.FEATHER))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "chicken_head"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ButchercraftItems.BONE_SAW.get()).define('I', Items.IRON_INGOT)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "bone_saw"));
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ButchercraftItems.BUTCHER_KNIFE.get())
				.define('I', Items.IRON_INGOT).define('S', Items.STICK).pattern(" II").pattern(" II").pattern("S  ")
				.unlockedBy("has_iron", has(Items.IRON_INGOT))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "butcher_knife"));
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ButchercraftItems.SKINNING_KNIFE.get())
				.define('I', Items.IRON_INGOT).define('S', Items.STICK).pattern(" II").pattern("S  ")
				.unlockedBy("has_iron", has(Items.IRON_INGOT))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "skinning_knife"));
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ButchercraftItems.GUT_KNIFE.get())
				.define('I', Items.IRON_INGOT).define('S', Items.STICK).pattern("I  ").pattern(" I ").pattern(" S ")
				.unlockedBy("has_iron", has(Items.IRON_INGOT))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "gut_knife"));

		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ButchercraftItems.HOOK_BLOCK_ITEM.get())
				.define('I', Items.IRON_INGOT).define('C', Items.CHAIN).define('N', Items.IRON_NUGGET).pattern("III")
				.pattern("NCN").pattern("NNN").unlockedBy("has_iron", has(Items.IRON_INGOT))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "meat_hook"));

		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ButchercraftItems.GRINDER_TIP.get())
				.define('I', Items.IRON_TRAPDOOR).define('C', Items.IRON_BARS).pattern("C  ").pattern("I  ")
				.unlockedBy("has_iron", has(Items.IRON_INGOT))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "grinder_tip"));

		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ButchercraftItems.EXTRUDER_TIP.get())
				.define('I', Items.IRON_TRAPDOOR).define('C', Items.IRON_INGOT).pattern("C  ").pattern("I  ")
				.unlockedBy("has_iron", has(Items.IRON_INGOT))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "extruder_tip"));

		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ButchercraftItems.GRINDER_BLOCK_ITEM.get())
				.define('S', Items.IRON_SWORD).define('P', Items.PISTON).define('C', Items.IRON_INGOT)
				.define('B', ItemTags.BUTTONS).define('H', Items.HOPPER).pattern("BH ").pattern("CSC").pattern("CPH")
				.unlockedBy("has_iron", has(Items.IRON_INGOT))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "grinder"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ButchercraftItems.MASK.get())
				.define('W', Items.LIGHT_BLUE_CARPET).define('S', Items.STRING).pattern("SWS")
				.unlockedBy("has_wool", has(Items.LIGHT_BLUE_CARPET))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "mask"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ButchercraftItems.BOOTS.get()).define('W', Items.BLACK_WOOL)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "boots"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ButchercraftItems.GLOVES.get())
				.define('W', Items.LIGHT_BLUE_WOOL).define('B', Items.LEATHER).define('F', ButchercraftItems.LARD.get())
				.pattern("W W").pattern("BFB").unlockedBy("has_wool", has(Items.LIGHT_BLUE_WOOL))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "gloves"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ButchercraftItems.APRON.get()).define('W', Items.WHITE_CARPET)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "apron"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ButchercraftItems.PAPER_HAT.get()).define('P', Items.PAPER)
				.pattern("PPP").pattern("P P").unlockedBy("has_paper", has(Items.PAPER))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "paper_hat"));

		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ButchercraftItems.BUTCHER_BLOCK_BLOCK_ITEM.get())
				.define('W', ItemTags.WOODEN_SLABS).define('S', Items.STICK).pattern("WWW").pattern("SWS")
				.unlockedBy("has_wood", has(ItemTags.WOODEN_SLABS))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "butcherblock"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ButchercraftItems.COW_HOOD.get())
				.define('H', ButchercraftItems.COW_HEAD_ITEM.get()).define('L', ButchercraftItems.COW_HIDE.get())
				.define('S', Tags.Items.STRINGS).pattern(" H ").pattern("SLS")
				.unlockedBy("has_head", has(ButchercraftItems.COW_HEAD_ITEM.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cow_hood"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ButchercraftItems.GOAT_HOOD.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "goat_hood"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ButchercraftItems.PIG_HOOD.get())
				.define('H', ButchercraftItems.PIG_HEAD_ITEM.get()).define('L', ButchercraftItems.PIG_HIDE.get())
				.define('S', Tags.Items.STRINGS).pattern(" H ").pattern("SLS")
				.unlockedBy("has_head", has(ButchercraftItems.PIG_HEAD_ITEM.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "pig_hood"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ButchercraftItems.SHEEP_HOOD.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "sheep_hood"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ButchercraftItems.CHICKEN_MASK.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "chicken_mask"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.BEEF_BLOCK_ITEM.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "beef_block"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_BEEF_BLOCK_ITEM.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_beef_block"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.PORK_BLOCK_ITEM.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "pork_block"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_PORK_BLOCK_ITEM.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_pork_block"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.MUTTON_BLOCK_ITEM.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "lamb_block"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_MUTTON_BLOCK_ITEM.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_lamb_block"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.GOAT_BLOCK_ITEM.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "goat_block"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_GOAT_BLOCK_ITEM.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_goat_block"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.CHICKEN_BLOCK_ITEM.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "chicken_block"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_CHICKEN_BLOCK_ITEM.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_chicken_block"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.RABBIT_BLOCK_ITEM.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "rabbit_block"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_RABBIT_BLOCK_ITEM.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_rabbit_block"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.BEEF_SCRAPS.get(), 9)
				.requires(ButchercraftItems.BEEF_BLOCK_ITEM.get())
				.unlockedBy("has_beef", has(ButchercraftItemTags.BEEF_RAW))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "beef_block_to_scraps"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_BEEF_SCRAPS.get(), 9)
				.requires(ButchercraftItems.COOKED_BEEF_BLOCK_ITEM.get())
				.unlockedBy("has_beef_cooked", has(ButchercraftItemTags.BEEF_COOKED)).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_beef_block_to_scraps"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.PORK_SCRAPS.get(), 9)
				.requires(ButchercraftItems.PORK_BLOCK_ITEM.get())
				.unlockedBy("has_pork", has(ButchercraftItemTags.PORK_RAW))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "pork_block_to_scraps"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_PORK_SCRAPS.get(), 9)
				.requires(ButchercraftItems.COOKED_PORK_BLOCK_ITEM.get())
				.unlockedBy("has_pork_cooked", has(ButchercraftItemTags.PORK_COOKED)).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_pork_block_to_scraps"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.MUTTON_SCRAPS.get(), 9)
				.requires(ButchercraftItems.MUTTON_BLOCK_ITEM.get())
				.unlockedBy("has_lamb", has(ButchercraftItemTags.MUTTON_RAW))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "lamb_block_to_scraps"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_MUTTON_SCRAPS.get(), 9)
				.requires(ButchercraftItems.COOKED_MUTTON_BLOCK_ITEM.get())
				.unlockedBy("has_lamb_cooked", has(ButchercraftItemTags.MUTTON_COOKED)).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_lamb_block_to_scraps"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.GOAT_SCRAPS.get(), 9)
				.requires(ButchercraftItems.GOAT_BLOCK_ITEM.get())
				.unlockedBy("has_goat", has(ButchercraftItemTags.GOAT_RAW))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "goat_block_to_scraps"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_GOAT_SCRAPS.get(), 9)
				.requires(ButchercraftItems.COOKED_GOAT_BLOCK_ITEM.get())
				.unlockedBy("has_goat_cooked", has(ButchercraftItemTags.MUTTON_COOKED)).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_goat_block_to_scraps"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.CHICKEN_SCRAPS.get(), 9)
				.requires(ButchercraftItems.CHICKEN_BLOCK_ITEM.get())
				.unlockedBy("has_chicken", has(ButchercraftItemTags.CHICKEN_RAW))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "chicken_block_to_scraps"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_CHICKEN_SCRAPS.get(), 9)
				.requires(ButchercraftItems.COOKED_CHICKEN_BLOCK_ITEM.get())
				.unlockedBy("has_chicken_cooked", has(ButchercraftItemTags.MUTTON_COOKED)).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_chicken_block_to_scraps"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.RABBIT_SCRAPS.get(), 9)
				.requires(ButchercraftItems.RABBIT_BLOCK_ITEM.get())
				.unlockedBy("has_rabbit", has(ButchercraftItemTags.RABBIT_RAW))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "rabbit_block_to_scraps"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_RABBIT_SCRAPS.get(), 9)
				.requires(ButchercraftItems.COOKED_RABBIT_BLOCK_ITEM.get())
				.unlockedBy("has_rabbit_cooked", has(ButchercraftItemTags.MUTTON_COOKED)).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_rabbit_block_to_scraps"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.BLOOD_SAUSAGE_BLOCK_ITEM.get(), 1)
				.requires(ButchercraftItems.BLOOD_SAUSAGE.get(), 9)
				.unlockedBy("has_blood_sausage", has(ButchercraftItems.BLOOD_SAUSAGE.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "blood_sausage_to_block"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.BLOOD_SAUSAGE.get(), 9)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "blood_sausage_from_block"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.SAUSAGE_BLOCK_ITEM.get(), 1)
				.requires(ButchercraftItems.SAUSAGE.get(), 9)
				.unlockedBy("has_sausage", has(ButchercraftItems.SAUSAGE.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "sausage_to_block"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.SAUSAGE.get(), 9)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "sausage_from__block"));

		ShapelessRecipeBuilder
				.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_BLOOD_SAUSAGE_BLOCK_ITEM.get(), 1)
				.requires(ButchercraftItems.COOKED_BLOOD_SAUSAGE.get(), 9)
				.unlockedBy("has_blood_sausage", has(ButchercraftItems.COOKED_BLOOD_SAUSAGE.get())).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_blood_sausage_to_block"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_BLOOD_SAUSAGE.get(), 9)
				...
				.save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_blood_sausage_from_block"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_SAUSAGE_BLOCK_ITEM.get(), 1)
				.requires(ButchercraftItems.COOKED_SAUSAGE.get(), 9)
				.unlockedBy("has_sausage", has(ButchercraftItems.COOKED_SAUSAGE.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_sausage_to_block"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.COOKED_SAUSAGE.get(), 9)
				.requires(ButchercraftItems.COOKED_SAUSAGE_BLOCK_ITEM.get(), 1)
				.unlockedBy("has_sausage_block", has(ButchercraftItems.COOKED_SAUSAGE_BLOCK_ITEM.get())).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cooked_sausage_from__block"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ButchercraftItems.BLOOD_SAUSAGE_MIX.get(), 8)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "blood_sausage_mix"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.RED_DYE, 2)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "blood_dye"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ButchercraftItems.LEATHER_CORD.get(), 3)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.TOOLS, ButchercraftItems.BLOOD_FLUID_BUCKET.get(), 1)
				...
				.unlockedBy("has_blood", has(ButchercraftItems.BLOOD_FLUID_BOTTLE.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "blood_bucket"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.TOOLS, ButchercraftItems.BLOOD_FLUID_BOTTLE.get(), 4)
				.requires(ButchercraftItems.BLOOD_FLUID_BUCKET.get(), 1).requires(Items.GLASS_BOTTLE, 4)
				.unlockedBy("has_blood", has(ButchercraftItems.BLOOD_FLUID_BOTTLE.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "blood_bottle"));

		ShapelessRecipeBuilder
				.shapeless(RecipeCategory.BUILDING_BLOCKS, ButchercraftItems.BARN_WOOD_BLOCK_ITEM.get(), 8)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "barn_wood"));

		ShapelessRecipeBuilder
				.shapeless(RecipeCategory.BUILDING_BLOCKS, ButchercraftItems.TRIMMED_BARN_WOOD_ITEM.get(), 1)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "trimmed_barn_wood"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.TOOLS, ButchercraftItems.SOAP.get(), 1)
				.requires(ButchercraftItems.LARD.get(), 1).requires(Items.BONE_MEAL, 1)
				.requires(Ingredient.of(ItemTags.FLOWERS))
				.unlockedBy("has_barn_wood", has(ButchercraftItems.LARD.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "soap"));

		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ButchercraftItems.BARN_WOOD_DOOR_ITEM.get(), 3)
				.pattern("xx ").pattern("xx ").pattern("xx ").define('x', ButchercraftItems.BARN_WOOD_BLOCK_ITEM.get())
				.unlockedBy("has_barn_wood", has(ButchercraftItems.BARN_WOOD_BLOCK_ITEM.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "barn_wood_door"));

		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ButchercraftItems.BARN_WOOD_SLAB_ITEM.get(), 6)
				.pattern("xxx").define('x', ButchercraftItems.BARN_WOOD_BLOCK_ITEM.get())
				.unlockedBy("has_barn_wood", has(ButchercraftItems.BARN_WOOD_BLOCK_ITEM.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "barn_wood_slab"));

		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ButchercraftItems.BARN_WOOD_STAIRS_ITEM.get(), 4)
				.pattern("x  ").pattern("xx ").pattern("xxx").define('x', ButchercraftItems.BARN_WOOD_BLOCK_ITEM.get())
				.unlockedBy("has_barn_wood", has(ButchercraftItems.BARN_WOOD_BLOCK_ITEM.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "barn_wood_stairs"));

		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ButchercraftItems.BARN_WOOD_TRAPDOOR_ITEM.get(), 2)
				.pattern("xxx").pattern("xxx").define('x', ButchercraftItems.BARN_WOOD_BLOCK_ITEM.get())
				.unlockedBy("has_barn_wood", has(ButchercraftItems.BARN_WOOD_BLOCK_ITEM.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "barn_wood_trapdoor"));

		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ButchercraftItems.BARN_WOOD_FENCE_ITEM.get(), 3)
				.pattern("xsx").pattern("xsx").define('x', ButchercraftItems.BARN_WOOD_BLOCK_ITEM.get())
				.define('s', Items.STICK).unlockedBy("has_barn_wood", has(ButchercraftItems.BARN_WOOD_BLOCK_ITEM.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "barn_wood_fence"));

		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, Items.CANDLE).pattern("s").pattern("t")
				.define('s', Tags.Items.STRINGS).define('t', ButchercraftItems.FAT.get())
				.unlockedBy("has_fat", has(ButchercraftItems.FAT.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "fat_candle"));

		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ButchercraftItems.BARN_WOOD_FENCE_GATE_ITEM.get())
				.pattern("sxs").pattern("sxs").define('x', ButchercraftItems.BARN_WOOD_BLOCK_ITEM.get())
				.define('s', Items.STICK).unlockedBy("has_barn_wood", has(ButchercraftItems.BARN_WOOD_BLOCK_ITEM.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "barn_wood_fence_gate"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.LEATHER)
				.requires(Ingredient.of(ButchercraftItems.LEATHER_SCRAP), 9)
		...
		GrinderRecipeBuilder
				.grind(Ingredient.of(ButchercraftItems.BEEF_SCRAPS.get()), RecipeCategory.FOOD, 1,
						Ingredient.of(ButchercraftItems.GRINDER_TIP.get()), ButchercraftItems.GROUND_BEEF.get(), 4, 2)
				.unlockedBy("has_beef_scrap", has(ButchercraftItems.BEEF_SCRAPS.get())).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "beef_scrap_to_ground_beef"));

		GrinderRecipeBuilder
				.grind(Ingredient.of(ButchercraftItems.PORK_SCRAPS.get()), RecipeCategory.FOOD, 1,
						Ingredient.of(ButchercraftItems.GRINDER_TIP.get()), ButchercraftItems.GROUND_PORK.get(), 4, 2)
				.unlockedBy("has_pork_scrap", has(ButchercraftItems.BEEF_SCRAPS.get())).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "pork_scrap_to_ground_pork"));

		GrinderRecipeBuilder
				.grind(Ingredient.of(ButchercraftItems.MUTTON_SCRAPS.get()), RecipeCategory.FOOD, 1,
						Ingredient.of(ButchercraftItems.GRINDER_TIP.get()), ButchercraftItems.GROUND_MUTTON.get(), 4, 2)
				.unlockedBy("has_mutton_scrap", has(ButchercraftItems.MUTTON_SCRAPS.get())).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "mutton_scrap_to_ground_mutton"));

		GrinderRecipeBuilder
				.grind(Ingredient.of(ButchercraftItems.GOAT_SCRAPS.get()), RecipeCategory.FOOD, 1,
						Ingredient.of(ButchercraftItems.GRINDER_TIP.get()), ButchercraftItems.GROUND_GOAT.get(), 4, 2)
				.unlockedBy("has_goat_scrap", has(ButchercraftItems.GOAT_SCRAPS.get())).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "goat_scrap_to_ground_goat"));

		GrinderRecipeBuilder.grind(Ingredient.of(ButchercraftItems.CHICKEN_SCRAPS.get()), RecipeCategory.FOOD, 1,
				Ingredient.of(ButchercraftItems.GRINDER_TIP.get()), ButchercraftItems.GROUND_CHICKEN.get(), 4, 2)
				.unlockedBy("has_chicken_scrap", has(ButchercraftItems.CHICKEN_SCRAPS.get())).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "chicken_scrap_to_ground_chicken"));

		GrinderRecipeBuilder
				.grind(Ingredient.of(ButchercraftItems.RABBIT_SCRAPS.get()), RecipeCategory.FOOD, 1,
						Ingredient.of(ButchercraftItems.GRINDER_TIP.get()), ButchercraftItems.GROUND_RABBIT.get(), 4, 2)
				.unlockedBy("has_rabbit_scrap", has(ButchercraftItems.RABBIT_SCRAPS.get())).save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "rabbit_scrap_to_ground_rabbit"));

		GrinderRecipeBuilder.grind(Ingredient.of(ButchercraftItemTags.GROUND_MEAT_RAW), RecipeCategory.FOOD, 8,
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "ground_beef_to_sausage"));

		GrinderRecipeBuilder
				.grind(Ingredient.of(ButchercraftItems.BLOOD_SAUSAGE_MIX.get()), RecipeCategory.FOOD, 8,
...
//						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "blood_bottle_to_bone_meal"));
	...
	private void createFoodRecipe(Ingredient pIngredient, ItemLike pResult, RecipeOutput consumer, String id) {
		SimpleCookingRecipeBuilder.smoking(pIngredient, RecipeCategory.FOOD, pResult, .35F, 100)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, id + "_from_smoking"));
		SimpleCookingRecipeBuilder.campfireCooking(pIngredient, RecipeCategory.FOOD, pResult, .35F, 600)
				.unlockedBy("has_" + BuiltInRegistries.ITEM.getKey(pIngredient.getItems()[0].getItem()).getPath(),
						has(pIngredient.getItems()[0].getItem()))
				.save(consumer,
						ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, id + "_from_campfire_cooking"));
		SimpleCookingRecipeBuilder.smelting(pIngredient, RecipeCategory.FOOD, pResult, .35F, 200)
				.unlockedBy("has_" + BuiltInRegistries.ITEM.getKey(pIngredient.getItems()[0].getItem()).getPath(),
						has(pIngredient.getItems()[0].getItem()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, id + "_from_smelting"));
	}
