...
public class ButchercraftRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(@Nonnull Consumer<FinishedRecipe> consumer) {
        MeatHookRecipeBuilder.shapedRecipe(COW_CARCASS.get())
                .tool(
                        Ingredient.of(SKINNING_KNIFE.get()), 6, true,
                ...
                .tool(
                        ...
                        new BlacklistedModel(DIAMOND_SWORD,
                                new AnimationFloatTransform().setRotation(
                                        new AnimatedFloatVector3().setY(new AnimatedFloat(0, 360, 0, 0.1f, true, false)))))
                .tool(
                        Ingredient.of(BONE_SAW.get()), 6, true,
                        new ResourceLocation(Butchercraft.MOD_ID, "recipes/meat_hook/delimb_cow"),
                        new BlacklistedModel(DIAMOND_SWORD,
                                new AnimationFloatTransform().setRotation(
                                        new AnimatedFloatVector3().setY(new AnimatedFloat(0, 360, 0, 0.1f, true, false)))))
                .tool(
                        Ingredient.of(BUTCHER_KNIFE.get()), 6, true,
        ...
        ShapedRecipeBuilder.shaped(BONE_SAW.get())
                .define('I', IRON_INGOT)
                .define('S', STICK)
                .pattern("IIS")
                .pattern("IIS")
        ...
        ShapedRecipeBuilder.shaped(BUTCHER_KNIFE.get())
                .define('I', IRON_INGOT)
                .define('S', STICK)
                .pattern(" II")
                .pattern(" II")
        ...
        ShapedRecipeBuilder.shaped(SKINNING_KNIFE.get())
                .define('I', IRON_INGOT)
                .define('S', STICK)
                .pattern(" II")
                .pattern(" I ")
    ...
    private void createFoodRecipe(Ingredient pIngredient, ItemLike pResult, Consumer<FinishedRecipe> consumer) {
        SimpleCookingRecipeBuilder.smoking(pIngredient, pResult, .35F, 100).unlockedBy("has_" + pIngredient.getItems()[0].getItem().getRegistryName().getPath(), has(pIngredient.getItems()[0].getItem())).save(consumer, new ResourceLocation(Butchercraft.MOD_ID, pResult.asItem().getRegistryName().getPath() + "_from_smoking"));
        SimpleCookingRecipeBuilder.campfireCooking(pIngredient, pResult, .35F, 600).unlockedBy("has_" + pIngredient.getItems()[0].getItem().getRegistryName().getPath(), has(pIngredient.getItems()[0].getItem())).save(consumer, new ResourceLocation(Butchercraft.MOD_ID, pResult.asItem().getRegistryName().getPath() + "_from_campfire_cooking"));
        SimpleCookingRecipeBuilder.smelting(pIngredient, pResult, .35F, 200).unlockedBy("has_" + pIngredient.getItems()[0].getItem().getRegistryName().getPath(), has(pIngredient.getItems()[0].getItem())).save(consumer, new ResourceLocation(Butchercraft.MOD_ID, pResult.asItem().getRegistryName().getPath() + "_from_smelting"));
    }
