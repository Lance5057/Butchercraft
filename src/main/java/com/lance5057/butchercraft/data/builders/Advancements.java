	...
	public void generate(@NotNull HolderLookup.Provider registries, @NotNull Consumer<AdvancementHolder> consumer,
		...
		root = Advancement.Builder.advancement()
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.BUTCHER_KNIFE.get()),
						...
						Optional.of(ResourceLocation.fromNamespaceAndPath("butchercraft", "textures/background.png")),
		...
		butcherknife = Advancement.Builder.advancement().parent(root)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.BUTCHER_KNIFE.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.butcherknife.desc"),
						Optional.empty(), AdvancementType.TASK, true, true, false))
				.addCriterion("butcherknife",
						InventoryChangeTrigger.TriggerInstance.hasItems(ButchercraftItems.BUTCHER_KNIFE.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "butcherknife"),
						existingFileHelper);
		...
		skinningknife = Advancement.Builder.advancement().parent(root)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.SKINNING_KNIFE.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.skinningknife.desc"),
						Optional.empty(), AdvancementType.TASK, true, true, false))
				.addCriterion("skinningknife",
						InventoryChangeTrigger.TriggerInstance.hasItems(ButchercraftItems.SKINNING_KNIFE.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "skinningknife"),
						existingFileHelper);
		...
		gutknife = Advancement.Builder.advancement().parent(root)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "gutknife"),
						existingFileHelper);
		...
		bonesaw = Advancement.Builder.advancement().parent(root)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.BONE_SAW.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.bonesaw.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("bonesaw",
						InventoryChangeTrigger.TriggerInstance.hasItems(ButchercraftItems.BONE_SAW.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "bonesaw"),
						existingFileHelper);
		...
		hook = Advancement.Builder.advancement().parent(butcherknife)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.HOOK_BLOCK_ITEM.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.hook.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("hook",
		...
		blood = Advancement.Builder.advancement().parent(butcherknife)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.BLOOD_FLUID_BUCKET.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.blood.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("blood",
						InventoryChangeTrigger.TriggerInstance.hasItems(ButchercraftItems.BLOOD_FLUID_BUCKET.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "blood"),
						existingFileHelper);
		...
		stink = Advancement.Builder.advancement().parent(blood)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.BEAK.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.stink.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("stink",
						EffectsChangedTrigger.TriggerInstance
								.hasEffects(MobEffectsPredicate.Builder.effects().and(ButchercraftMobEffects.STINKY)))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "stink"),
						existingFileHelper);
		...
		bloody = Advancement.Builder.advancement().parent(blood)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.BLOOD_FLUID_BOTTLE.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.bloody.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("bloody",
						EffectsChangedTrigger.TriggerInstance
								.hasEffects(MobEffectsPredicate.Builder.effects().and(ButchercraftMobEffects.BLOODY)))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "bloody"),
						existingFileHelper);
		...
		trail = Advancement.Builder.advancement().parent(blood)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.BLOOD_SAUSAGE_LINKED.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.trail.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("trail",
						EffectsChangedTrigger.TriggerInstance.hasEffects(
								MobEffectsPredicate.Builder.effects().and(ButchercraftMobEffects.BLOODTRAIL)))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "trail"),
						existingFileHelper);
		...
		hands = Advancement.Builder.advancement().parent(blood)
				.display(new DisplayInfo(new ItemStack(Items.DIRT),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.hands.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("hands",
						EffectsChangedTrigger.TriggerInstance
								.hasEffects(MobEffectsPredicate.Builder.effects().and(ButchercraftMobEffects.DIRTY)))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "hands"),
						existingFileHelper);
		...
		soap = Advancement.Builder.advancement().parent(blood)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.SOAP.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.soap.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
		...
		apron = Advancement.Builder.advancement().parent(bloody)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.APRON.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.apron.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
		...
		gloves = Advancement.Builder.advancement().parent(hands)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.GLOVES.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.gloves.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
		...
		boots = Advancement.Builder.advancement().parent(trail)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.BOOTS.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.boots.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
		...
		mask = Advancement.Builder.advancement().parent(stink)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.MASK.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.mask.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
		...
		hat = Advancement.Builder.advancement().parent(root)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.PAPER_HAT.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.hat.desc"), Optional.empty(),
		...
		butcher_block = Advancement.Builder.advancement().parent(butcherknife)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.BUTCHER_BLOCK_BLOCK_ITEM.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.butcherblock.desc"),
						Optional.empty(), AdvancementType.TASK, true, true, false))
				.addCriterion("butcherblock",
						InventoryChangeTrigger.TriggerInstance
								.hasItems(ButchercraftItems.BUTCHER_BLOCK_BLOCK_ITEM.get()))
		...
		cow = Advancement.Builder.advancement().parent(hook)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.COW_CARCASS.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.cow.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("cow",
		...
		pig = Advancement.Builder.advancement().parent(hook)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.PIG_CARCASS.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.pig.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("pig",
		...
		sheep = Advancement.Builder.advancement().parent(hook)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.SHEEP_CARCASS.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.sheep.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("sheep",
		...
		goat = Advancement.Builder.advancement().parent(hook)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.GOAT_CARCASS.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.goat.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("goat",
		...
		rabbit = Advancement.Builder.advancement().parent(butcher_block)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.BROWN_RABBIT_CARCASS.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.rabbit.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("rabbit", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(
						...
						ButchercraftItems.SPLOTCHED_RABBIT_CARCASS.get(),
						ButchercraftItems.WHITE_RABBIT_CARCASS.get())))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "rabbit"),
						existingFileHelper);
		...
		chicken = Advancement.Builder.advancement().parent(butcher_block)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.CHICKEN_CARCASS.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.chicken.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("chicken",
						InventoryChangeTrigger.TriggerInstance.hasItems(ButchercraftItems.CHICKEN_CARCASS.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "chicken"),
						existingFileHelper);
		...
		grinder = Advancement.Builder.advancement().parent(root)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.GRINDER_BLOCK_ITEM.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.grinder.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
		...
		grinder_tip = Advancement.Builder.advancement().parent(grinder)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.GRINDER_TIP.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.grinder_tip.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
		...
		extruder = Advancement.Builder.advancement().parent(grinder)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.EXTRUDER_TIP.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.extruder.desc"), Optional.empty(),
						AdvancementType.TASK, true, true, false))
				.addCriterion("extruder",
						InventoryChangeTrigger.TriggerInstance.hasItems(ButchercraftItems.EXTRUDER_TIP.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "extruder"),
						existingFileHelper);
		...
		sausage = Advancement.Builder.advancement().parent(extruder)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.SAUSAGE.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.sausage.desc"), Optional.empty(),
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "sausage"),
						existingFileHelper);
		...
		bunny_equip = Advancement.Builder.advancement().parent(rabbit)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "bunny_equip"),
						existingFileHelper);
		...
		taxadermy = Advancement.Builder.advancement().parent(root)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "taxadermy"),
						existingFileHelper);
		...
		whole_cow = Advancement.Builder.advancement().parent(cow)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "whole_cow"),
						existingFileHelper);
		...
		whole_pig = Advancement.Builder.advancement().parent(pig)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "whole_pig"),
						existingFileHelper);
		...
		whole_sheep = Advancement.Builder.advancement().parent(sheep)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "whole_sheep"),
						existingFileHelper);
		...
		whole_rabbit = Advancement.Builder.advancement().parent(rabbit)
				.display(new DisplayInfo(new ItemStack(Items.COOKED_RABBIT),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.whole_rabbit.desc"),
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "whole_rabbit"),
						existingFileHelper);
		...
		whole_chicken = Advancement.Builder.advancement().parent(chicken)
				.display(new DisplayInfo(new ItemStack(Items.COOKED_CHICKEN),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.whole_chicken.desc"),
						Optional.empty(), AdvancementType.CHALLENGE, true, true, false))
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "whole_chicken"),
						existingFileHelper);
		...
		whole_goat = Advancement.Builder.advancement().parent(goat)
				...
				.addCriterion("whole_goat_ground",
						ConsumeItemTrigger.TriggerInstance.usedItem(ButchercraftItems.COOKED_GROUND_MUTTON.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "whole_goat"),
						existingFileHelper);
		...
		everything = Advancement.Builder.advancement().parent(butcherknife)
				...
				.addCriterion("whole_sheep_ground",
						ConsumeItemTrigger.TriggerInstance.usedItem(ButchercraftItems.COOKED_GROUND_MUTTON.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "everything"),
						existingFileHelper);
		...
		everything_plus = Advancement.Builder.advancement().parent(everything)
				.display(new DisplayInfo(new ItemStack(ButchercraftItems.COOKED_TRIPE.get()),
						...
						Component.translatable(Butchercraft.MOD_ID + ".advancement.everything_plus.desc"),
						Optional.empty(), AdvancementType.CHALLENGE, true, true, false))
				.addCriterion("whole_cow_ribs",
						ConsumeItemTrigger.TriggerInstance.usedItem(ButchercraftItems.COOKED_BEEF_RIBS.get()))
				.addCriterion("whole_cow_roast",
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "everything_plus"),
						existingFileHelper);
		...
		DisplayInfo dheart = new DisplayInfo(new ItemStack(ButchercraftItems.HEART.get()),
				...
				Component.translatable(Butchercraft.MOD_ID + ".advancement.heart.desc"), Optional.empty(),
		...
		heart = Advancement.Builder.advancement().parent(root).display(dheart)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "heart"),
						existingFileHelper);
		...
		cannibalism = Advancement.Builder.advancement().parent(root)
				.display(new DisplayInfo(new ItemStack(Items.PLAYER_HEAD),
						...
						AdvancementType.CHALLENGE, true, true, true))
				.addCriterion("cannibalism", PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(Optional.empty(),
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(Butchercraft.MOD_ID, "cannibalism"),
						existingFileHelper);
	}
}
