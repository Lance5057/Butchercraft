	...
	protected void buildCraftingRecipes(@Nonnull Consumer<FinishedRecipe> consumer) {
		CookingPotRecipeBuilder
				.cookingPotRecipe(ButchercraftItems.KETCHUP_JAR_ITEM.get(), 1, CookingRecipes.NORMAL_COOKING, 1.0F,
						Items.GLASS_BOTTLE)
				.addIngredient(ForgeTags.VEGETABLES_TOMATO).addIngredient(Items.SUGAR).build(consumer);
		...
		CookingPotRecipeBuilder
				...
				.addIngredient(Items.SUGAR).build(consumer, "bbq_sugar");

		CookingPotRecipeBuilder
				.cookingPotRecipe(ButchercraftItems.BBQ_JAR_ITEM.get(), 1, CookingRecipes.NORMAL_COOKING, 1.0F,
						Items.GLASS_BOTTLE)
				.addIngredient(ForgeTags.VEGETABLES_TOMATO).addIngredient(ForgeTags.VEGETABLES_ONION)
				.addIngredient(Items.HONEY_BOTTLE).build(consumer, "bbq_honey");

		CookingPotRecipeBuilder
				.cookingPotRecipe(ButchercraftItems.STOCK_JAR_ITEM.get(), 1, CookingRecipes.NORMAL_COOKING, 1.0F,
						Items.GLASS_BOTTLE)
				.addIngredient(ForgeTags.VEGETABLES).addIngredient(Tags.Items.BONES).build(consumer);
		...
		CookingPotRecipeBuilder
				...
				.addIngredient(Items.POTATO).build(consumer);
		...
		CookingPotRecipeBuilder
				...
				.addIngredient(ForgeTags.MILK).build(consumer);

		CookingPotRecipeBuilder.cookingPotRecipe(ButchercraftItems.LARD.get(), 1, CookingRecipes.NORMAL_COOKING, 0.35F)
				.addIngredient(ButchercraftItems.FAT.get()).addIngredient(ButchercraftItems.FAT.get()).build(consumer);
		...
		CookingPotRecipeBuilder
				...
				.addIngredient(ButchercraftItems.KETCHUP_JAR_ITEM.get()).build(consumer);
